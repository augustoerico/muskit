...
1. Mutation Selection: A user can specify the gates to be used for generation of mutants
2. Extension: A user can specify the new gates here and the tool will also use them for 
    mutation generation
The default file contains all the current supported gates
Note: One must specify a gate in multiple sets. For example, a one qubit gate must be 
    specified both in AllGates and also in OneQubit
"""
